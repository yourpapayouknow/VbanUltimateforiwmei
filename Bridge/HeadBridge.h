...
@property (nonatomic, assign) uint64_t underrunCount;
@property (nonatomic, assign) uint64_t overloadCount;
@property (nonatomic, assign) uint64_t corruptCount;
...
@property (nonatomic, assign) uint64_t totalDisorder;
@property (nonatomic, assign) uint64_t totalUnderrun;
@property (nonatomic, assign) uint64_t totalOverload;
@property (nonatomic, assign) uint64_t totalCorrupt;
@property (nonatomic, assign) uint64_t totalError;
